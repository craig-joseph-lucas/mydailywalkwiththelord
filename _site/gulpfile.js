...
gulp.task('jekyll-dev', function(done) {
    ...
    return cp.spawn('bundle', ['exec', 'jekyll', 'build', '--future', '--config', '_config.yml,_config_dev.yml'], {
        stdio: 'inherit'
    })
        .on('close', done);
});
...
gulp.task('watch', function() {
    gulp.watch(['_assets/css/**/*.scss', '_assets/css/*.scss'], ['sass']);
    gulp.watch(['index.html', '_layouts/*.html', '_posts/*', '_includes/*.html', '*.md', '*.html'], ['jekyll-rebuild']);
});
